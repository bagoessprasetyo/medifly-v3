...
const MainApp: React.FC = () => {
    const [page, setPage] = useState<'home' | 'marketplace' | 'hospital-page' | 'doctors' | 'doctor-details' | 'gallery' | 'facilities' | 'facility-details' | 'packages' | 'package-details' | 'specialization-details' | 'hospital-insights' | 'article-details' | 'research-details' | 'treatment-details' | 'country-details'>('home');
    ...
    const handleNavigateToCountry = (countryName: string) => {
        setViewedCountry(countryName);
        setPage('country-details');
        safePushState(`/country/${createSlug(countryName)}`);
    };
            ...
            >
                ...
                <Layout {...layoutProps}>
                    <AnimatePresence mode="wait">
                        {page === 'home' && (
                            <PageTransition key="home">
                                <Hero
                                    ...
                                    onNavigateToMarketplace={navigateToMarketplace}
                                />
                                <ExploreHospitals onNavigateToCountry={handleNavigateToCountry} />
                                <HealthPotential />
                                <MedicalTeam />
                                <Testimonials />
                                <Mission />
                        ...
                        {page === 'marketplace' && (
                            <PageTransition key="marketplace">
                                <Marketplace
                                    filters={filters}
                        ...
                        {page === 'hospital-page' && viewedHospital && (
                            <PageTransition key="hospital-page">
                                <HospitalPage
                        ...
                        {page === 'facility-details' && viewedHospital && viewedFacilityName && (
                            <PageTransition key="facility-details">
                                <FacilityDetailsPage
                                    hospital={viewedHospital}
                        ...
                        {page === 'specialization-details' && viewedHospital && viewedSpecializationName && (
                            <PageTransition key="specialization-details">
                        ...
                        {page === 'treatment-details' && viewedHospital && viewedSpecializationName && viewedTreatmentName && (
                            <PageTransition key="treatment-details">
                        ...
                        {page === 'hospital-insights' && viewedHospital && (
                            <PageTransition key="hospital-insights">
                        ...
                        {page === 'article-details' && viewedHospital && viewedArticleTitle && (
                            <PageTransition key="article-details">
                                <ArticleDetailsPage
                                    hospital={viewedHospital}
                        ...
                        {page === 'research-details' && viewedHospital && viewedResearchTitle && (
                            <PageTransition key="research-details">
                                <ResearchDetailsPage
                                    hospital={viewedHospital}
                        ...
                        {page === 'doctor-details' && viewedDoctor && (
                            <PageTransition key="doctor-details">
                                <DoctorDetailsPage
                                    doctor={viewedDoctor}
                                    onBack={handleBackFromDoctor}
                                    onNavigateToHospital={handleNavigateToHospitalById}
                                    onViewDoctor={handleNavigateToDoctor}
                                    onViewSpecialization={(spec) => {
                                        setFilters({ searchQuery: '', specialization: spec });
                                        setPage('marketplace');
                                        safePushState('/');
                                    }}
                                />
                        ...
                        {page === 'package-details' && viewedPackage && (
                            <PageTransition key="package-details">
                                <PackageDetailsPage
                        ...
                        {page === 'country-details' && viewedCountry && (
                            <PageTransition key="country-details">
                                <CountryPage
                                    countryName={viewedCountry}
