...
export const HOSPITALS: Hospital[] = [
  ...
  },
  {
    ...
    location: 'Denpasar',
    country: 'Indonesia',
    coordinates: { lat: -8.678755, lng: 115.259397 },
    specialties: ['Cardiology', 'Oncology', 'Neurology', 'Gastroenterology', 'Hepatology', 'Orthopedics'],
    rating: 4.7,
    reviewCount: 257,
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/articles/b0b116bb-625f-47bf-b22a-d2e1f6d966b8.jpg',
    images: [
      'https://storage.googleapis.com/web-bih-bh-devel/articles/b0b116bb-625f-47bf-b22a-d2e1f6d966b8.jpg',
      'https://storage.googleapis.com/web-bih-bh-devel/public/assets/general/4712b518-9f11-4f7d-ab4f-befa3c57e765.webp',
      'https://storage.googleapis.com/web-bih-bh-devel/public/assets/general/0d7e3cd3-3200-4b2e-bbab-bb58ab1659ff.webp',
...
export const HOSPITAL_DETAILS: HospitalDetails[] = [
  ...
  // ==================== BALI INTERNATIONAL HOSPITAL (ID: 141) ====================
  {
    hospitalId: '141',
    fullAddress: 'Jalan Kawasan Ekonomi Khusus Sanur, Lot H1 – H2, Desa/Kelurahan Sanur Kaja, Kec. Denpasar Selatan, Denpasar, Bali',
    postalCode: '80227',
    yearEstablished: 2024,
    fullDescription: 'Bali International Hospital (BIH), the flagship institution in the Sanur Special Economic Zone, is dedicated to ending the need for Indonesians to travel abroad for premium healthcare. BIH delivers world-class, personalized care through five Centers of Excellence (CoEs): Cardiology, Oncology, Neurology, Gastroenterology/Hepatology, and Orthopedics. The hospital features advanced medical technology, including specialized equipment like LINAC and 3 Tesla MRI within the Oncology CoE (in partnership with Icon Cancer Centre). With 255 beds, 38 ICUs, and 8 operating rooms, BIH is setting new international standards. It strategically blends medical excellence and clinical expertise with a focus on patient comfort, embodying the principle of \'World-Class Care, Balinese Heart\' to become a premier medical tourism destination in Southeast Asia.',
    awards: [
      { year: '2024', title: 'Among Japan\'s Top Providers in Cardiology & Heart Health', org: 'Sapporo Cardio Vascular Clinic' },
      { year: '2024', title: 'Global Leader in Oncology & Cancer Treatment', org: 'Icon Cancer Center' },
      { year: '2024', title: 'Southeast Asia\'s Leading Provider of Advanced Laboratory Diagnostics', org: 'Innoquest' },
      { year: '2024', title: 'Knowledge Partner from Singapore', org: 'SingHealth' },
    ],
    insurancePartners: ['Onecare', 'APRIL International', 'Bupa', 'Europ Assistance', 'Medlinx', 'Meditap', 'International SOS', 'AXA', 'MSIG', 'Allianz', 'Mandiri inHealth', 'Prudential', 'BNI Life', 'BRI Life', 'CAR', 'BCA Life', 'MedicAssist', 'Global Assistance & Healthcare', 'mQAre'],
    leadership: [
      { position: 'Medical Director', name: 'Dr. Francis Chin Kuok Choon' },
      { position: 'Head of Oncology CoE', name: 'Dr. Karmen Wong' },
      { position: 'Head of Orthopedics CoE', name: 'Dr. Erwin Saspraditya' },
      { position: 'Head of Cardiology CoE', name: 'Dr. Tsutomu Fujita' },
      { position: 'Head of Internal Medicine', name: 'Dr. Losen Adnyana' },
    ],
    doctors: [
      { id: 'bih141-1', name: 'Dr. Francis Chin Kuok Choon', role: 'Radiation Oncologist', specialization: 'Oncology', subSpecialization: 'Radiation Oncology', experience: 20, surgeries: 0, fellowship: 'EU MSc in Radiation Biology, University College London', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. Francis Chin Kuok Choon is a highly experienced radiation oncologist with over 20 years of expertise. An ASEAN and Chevening Scholar, he was the first student from Asia to complete the prestigious EU MSc in Radiation Biology at University College London. Before joining Icon Cancer Centre, Dr. Chin spent over two decades at National Cancer Centre Singapore (NCCS).', achievements: 'President-Elect of SEAROG, contributed to Oxford Textbook of Critical Care, recognized by IAEA for radiation oncology advancements.', publications: 'Contributions to global medical literature including Oxford Textbook of Critical Care.', conditions: ['Breast Cancer', 'Gynaecological Cancer', 'Gastrointestinal Cancer', 'Prostate Cancer', 'Paediatric Cancer', 'Soft Tissue Sarcoma'], treatments: ['Radiation Therapy', 'Proton Therapy', 'Brachytherapy', 'IMRT'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/37a3c2fc-525c-4a14-94c4-ca743ae01fc9.png' },
      { id: 'bih141-2', name: 'Dr. Karmen Wong', role: 'Medical Oncologist', specialization: 'Oncology', subSpecialization: 'Medical Oncology', experience: 30, surgeries: 0, fellowship: 'HMDP Scholarship, University of California San Francisco (UCSF)', availability: 'Mon–Fri, 9am–5pm', about: 'Dr Karmen Wong is a medical oncologist with more than 30 years of clinical practice. She received her oncology training at the National University Hospital (NUH), National Cancer Centre, Singapore (NCC) and University of California, San Francisco (UCSF). She helped establish the first multi-disciplinary breast cancer treatment in Singapore 20 years ago.', achievements: 'Initiated bone marrow transplant programme in solid tumour in SGH in 1997, presented 1st Asian study on breast cancer treatment attitudes at ASCO 1999.', publications: 'Numerous peer review articles and textbook chapters, co-investigator in CompLEEment-1 trial (ASCO 2019, ESMO 2018).', conditions: ['Breast Cancer', 'Gastrointestinal Cancer', 'Gynaecological Cancer', 'All Cancer Types'], treatments: ['Chemotherapy', 'Targeted Therapy', 'Immunotherapy', 'Cancer Support Network'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/5d2bac16-fc59-48a0-92be-d55ba51b6d86.jpg' },
      { id: 'bih141-3', name: 'Dr. Erwin Saspraditya', role: 'Hip & Knee Consultant', specialization: 'Orthopedics', subSpecialization: 'Hip and Knee Surgery', experience: 10, surgeries: 2000, fellowship: 'Clinical Fellowship Kure Hospital Hiroshima Japan, Indonesian Hip and Knee Consultant', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. Erwin Saspraditya, B. Med Sci, is an experienced orthopedic surgeon specializing in hip and knee procedures. He earned his qualifications from the Indonesian Orthopaedic and Traumatology College and completed training at Universitas Udayana. With over 10 years of experience at Siloam Hospital Bali.', achievements: 'Expert in hip and knee replacement surgery with international fellowship training.', publications: 'Research on hip and knee reconstruction.', conditions: ['Osteoarthritis', 'Hip Dysplasia', 'Knee Injuries', 'Joint Degeneration'], treatments: ['Total Hip Replacement', 'Total Knee Replacement', 'Knee Arthroscopy', 'Joint Reconstruction'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/cf82714c-c00e-11ef-82c8-0242ac120003.jpg' },
      { id: 'bih141-4', name: 'Dr. Mintareja Teguh', role: 'Fetomaternal Medicine Consultant', specialization: 'Obstetrics & Gynecology', subSpecialization: 'Fetomaternal Medicine', experience: 20, surgeries: 0, fellowship: 'PhD in Medicine, Padjajaran University; Advanced Course Fetomaternal Medicine, Barcelona University', availability: 'Mon–Fri, 8am–4pm', about: 'Dr. Mintareja Teguh, PhD is a senior Obstetrician and Gynecologist with subspecialty expertise in Fetomaternal Medicine. With over 20 years of clinical experience, he is highly regarded for his work in managing high-risk pregnancies, fetal diagnostics, and complex maternal conditions.', achievements: 'Expert in high-risk pregnancy management and fetal diagnostics.', publications: 'Research on fetomaternal medicine and high-risk pregnancies.', conditions: ['High-risk Pregnancy', 'Fetal Anomalies', 'Maternal Complications', 'Multiple Gestations'], treatments: ['Fetal Diagnostics', 'High-risk Pregnancy Management', 'Prenatal Screening', 'Maternal-fetal Intervention'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/eaf5d407-7bd4-47db-9ac4-53dd1cc398af.jpg' },
      { id: 'bih141-5', name: 'Dr. I Dewa Gde Dwi Sumajaya', role: 'Interventional Cardiologist', specialization: 'Cardiology', subSpecialization: 'Cardiology Intervention', experience: 10, surgeries: 1500, fellowship: 'Interventional Cardiology, Queen Elizabeth Hospital II Malaysia; Observership SCVC Japan', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. I Dewa Gde Dwi Sumajaya, M.Biomed, FIHA is a distinguished expert in Cardiology and Vascular Medicine, with a focus on Cardiology Intervention. He completed his medical degree at Universitas Udayana and specialized in Interventional Cardiology at Queen Elizabeth Hospital II in Malaysia and SCVC Japan.', achievements: 'Expert in minimally invasive cardiac procedures including angioplasty and stenting.', publications: 'Research on cardiovascular interventions.', conditions: ['Coronary Artery Disease', 'Heart Attack', 'Angina', 'Peripheral Vascular Disease'], treatments: ['Angioplasty', 'Stenting', 'Cardiac Catheterization', 'Coronary Intervention'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/4b5dfeaa-7bf7-4deb-bddc-a9ca0281e205.jpg' },
      { id: 'bih141-6', name: 'Dr. Ida Ayu Ratna Dewi Arrisna Artha', role: 'Shoulder & Elbow Surgeon', specialization: 'Orthopedics', subSpecialization: 'Shoulder and Elbow Surgery', experience: 7, surgeries: 1200, fellowship: 'Fellowship Shoulder Elbow Surgery and Sports Medicine, Thammasat University Thailand', availability: 'Mon–Fri, 9am–5pm', about: 'Dr. Ida Ayu Ratna Dewi Arrisna Artha is an orthopedic surgeon specializing in shoulder and elbow surgery, with a strong focus on sports medicine. She treats professional athletes and people with disorders related to aging, overuse and accidents.', achievements: 'Expert in arthroscopic surgery and shoulder/elbow joint replacement.', publications: 'Research on shoulder and elbow injuries in athletes.', conditions: ['Rotator Cuff Injury', 'Shoulder Instability', 'Tennis Elbow', 'Elbow Arthritis'], treatments: ['Arthroscopic Rotator Cuff Repair', 'Shoulder Replacement', 'Elbow Arthroscopy', 'Sports Injury Treatment'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/cd8f7e1f-092d-4b36-8a77-367cf839775a.jpeg' },
      { id: 'bih141-7', name: 'Dr. Tsutomu Fujita', role: 'Interventional Cardiologist', specialization: 'Cardiology', subSpecialization: 'Complex High-Risk Interventions', experience: 25, surgeries: 30000, fellowship: 'Japanese Association of Cardiovascular Intervention and Therapeutics; Rotablator and Robotic PCI Proctor', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. Tsutomu Fujita is a renowned interventional cardiologist with advanced expertise in complex high-risk procedures. He specializes in Rotablator, Complex High-Risk Indicated Procedures (CHIP), Chronic Total Occlusion (CTO), and more. Recognized as both a "Rota Master" and "CTO Master," he has successfully performed over 30,000 PCI procedures.', achievements: 'Rota Master and CTO Master, performed over 30,000 PCI procedures, Certified Rotablator and Robotic PCI Proctor and Preceptor.', publications: 'Publications on complex PCI interventions.', conditions: ['Complex Coronary Disease', 'Chronic Total Occlusion', 'Calcified Lesions', 'High-Risk PCI'], treatments: ['Rotablator', 'CHIP', 'CTO Intervention', 'Coronary Laser Angioplasty', 'EVT', 'Ablation', 'Pacemaker Implantation'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/b32db6b3-f00a-4543-92f9-5a310952efff.png' },
      { id: 'bih141-8', name: 'Dr. Ni Made Renny Anggreni Rena', role: 'Hematology Oncology Consultant', specialization: 'Internal Medicine', subSpecialization: 'Hematology and Medical Oncology', experience: 15, surgeries: 0, fellowship: 'Consultant Hematology Oncology, Universitas Udayana', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. Ni Made Renny Anggreni Rena is a distinguished consultant in Internal Medicine with a specialization in Hematology and Medical Oncology. With over a decade of experience, she is a pivotal member of the Staff Division of Internal Medicine at FK Unud/RSUP Prof. Dr. I. G.N.G. Ngoerah.', achievements: 'Expert in blood disorders and cancer treatment.', publications: 'Significant research in hematology and oncology.', conditions: ['Leukemia', 'Lymphoma', 'Anemia', 'Blood Clotting Disorders'], treatments: ['Chemotherapy', 'Blood Transfusion', 'Bone Marrow Evaluation', 'Hematologic Treatment'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/fa24cbf0-7f73-4b30-830b-3086fd38e961.JPG' },
      { id: 'bih141-9', name: 'Dr. Losen Adnyana', role: 'Medical Oncologist & Hematologist', specialization: 'Internal Medicine', subSpecialization: 'Medical Oncology and Hematology', experience: 30, surgeries: 0, fellowship: 'PhD in Medical Sciences, Udayana University; Chair of Indonesian Oncology Association (POI) Bali', availability: 'Mon–Fri, 8am–5pm', about: 'Dr. Losen is a medical oncologist and haematologist with close to 30 years of clinical experience. He serves as Head of Hematology and Medical Oncology division at Prof. Ngoerah Hospital, and Chair of the Indonesian Oncology Association (POI) Bali chapter. Member of ESMO, Perhompedin, PAPDI, and PHTDI.', achievements: 'Chair of Indonesian Oncology Association Bali, over 20 years research contributions nationally and internationally.', publications: 'Research on thrombocytopenia, leukemia diagnostics, supportive care during chemotherapy.', conditions: ['Solid Tumors', 'Hematologic Malignancies', 'Anemia', 'Thrombocytopenia'], treatments: ['Chemotherapy', 'Targeted Therapy', 'Supportive Care', 'Clinical Research'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/75635f35-a368-4064-a5d9-9ae1e8130011.webp' },
      { id: 'bih141-10', name: 'Dr. Ni Made Rai Wahyuni Setiawati', role: 'Neurologist', specialization: 'Neurology', subSpecialization: 'Neurorestoration and Neuroengineering', experience: 2, surgeries: 0, fellowship: 'Neurology, Universitas Udayana', availability: 'Mon–Fri, 9am–5pm', about: 'Dr. Ni Made Rai Wahyuni Setiawati is a consultant neurologist specializing in Neurorestoration and Neuroengineering. She completed her Neurologist degree at Universitas Udayana in 2023, focusing on advancing treatments for neurological recovery and rehabilitation.', achievements: 'Specialist in neurological recovery and rehabilitation.', publications: 'Research on neurorestoration techniques.', conditions: ['Stroke', 'Traumatic Brain Injury', 'Spinal Injury', 'Neurological Disorders'], treatments: ['Neurorestoration', 'Neurological Rehabilitation', 'Therapeutic Techniques', 'Recovery Programs'], imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/cc43db0c-bb4e-4f8a-8e12-26f6ef2cae54.JPG' },
    ],
  },
];
...
export const DOCTORS: Doctor[] = [
  ...
  {
    id: '121',
    name: 'Dr. Francis Chin Kuok Choon',
    specialty: 'Oncology',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/37a3c2fc-525c-4a14-94c4-ca743ae01fc9.png?1750038229',
    languages: ['English', 'Indonesian', 'Mandarin'],
    experienceYears: 20,
    procedures: ['Radiation Therapy', 'Cancer Treatment', 'Radiotherapy Planning'],
    gender: 'Male',
    rating: 4.9,
    reviewCount: 245
  },
  {
    ...
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/5d2bac16-fc59-48a0-92be-d55ba51b6d86.jpg?1751357388',
    languages: ['English', 'Indonesian', 'Mandarin'],
    experienceYears: 30,
    procedures: ['Medical Oncology', 'Chemotherapy', 'Targeted Therapy', 'Immunotherapy'],
    gender: 'Female',
    rating: 4.9,
    reviewCount: 312
  },
  {
    id: '123',
    name: 'Dr. Erwin Saspraditya',
    specialty: 'Orthopedics',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/cf82714c-c00e-11ef-82c8-0242ac120003.jpg',
    languages: ['Indonesian', 'English'],
    experienceYears: 10,
    procedures: ['Orthopedic Surgery', 'Joint Replacement', 'Sports Medicine'],
    gender: 'Male',
    rating: 4.8,
    reviewCount: 178
  },
  {
    id: '124',
    name: 'Dr. Mintareja Teguh',
    specialty: 'Obstetrics & Gynecology',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/eaf5d407-7bd4-47db-9ac4-53dd1cc398af.jpg?1764128467',
    languages: ['Indonesian', 'English'],
    experienceYears: 20,
    procedures: ['Obstetrics', 'Gynecological Surgery', 'Prenatal Care'],
    gender: 'Male',
    rating: 4.9,
    reviewCount: 267
  },
  {
    id: '125',
    name: 'Dr. I Dewa Gde Dwi Sumajaya',
    specialty: 'Cardiology',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/4b5dfeaa-7bf7-4deb-bddc-a9ca0281e205.jpg',
    languages: ['Indonesian', 'English'],
    experienceYears: 10,
    procedures: ['Interventional Cardiology', 'Cardiac Catheterization', 'Heart Disease Management'],
    gender: 'Male',
    rating: 4.8,
    reviewCount: 156
  },
  {
    id: '126',
    name: 'Dr. Ida Ayu Ratna Dewi Arrisna Artha',
    specialty: 'Orthopedics',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    ...
    languages: ['Indonesian', 'English'],
    experienceYears: 7,
    procedures: ['Orthopedic Surgery', 'Trauma Surgery', 'Bone Fracture Treatment'],
    gender: 'Female',
    rating: 4.7,
    reviewCount: 98
  },
  {
    id: '127',
    name: 'Dr. Tsutomu Fujita',
    specialty: 'Cardiology',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/b32db6b3-f00a-4543-92f9-5a310952efff.png?1751355113',
    languages: ['Japanese', 'English', 'Indonesian'],
    experienceYears: 25,
    procedures: ['Cardiovascular Surgery', 'Heart Valve Surgery', 'CABG'],
    gender: 'Male',
    rating: 4.9,
    reviewCount: 289
  },
  {
    id: '128',
    name: 'Dr. Ni Made Renny Anggreni Rena',
    specialty: 'Internal Medicine',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/2f10dd0c-c00f-11ef-82c8-0242ac120003.jpg',
    languages: ['Indonesian', 'English'],
    experienceYears: 15,
    procedures: ['Internal Medicine', 'Diabetes Management', 'Hypertension Treatment'],
    gender: 'Female',
    rating: 4.8,
    reviewCount: 187
  },
  {
    ...
    languages: ['Indonesian', 'English'],
    experienceYears: 30,
    procedures: ['Medical Oncology', 'Internal Medicine', 'Hematology'],
    gender: 'Male',
    rating: 4.9,
    reviewCount: 298
  },
  {
    id: '130',
    name: 'Dr. Ni Made Rai Wahyuni Setiawati',
    specialty: 'Neurology',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    ...
    languages: ['Indonesian', 'English'],
    experienceYears: 2,
    procedures: ['Neurology', 'Stroke Management', 'Headache Treatment'],
    gender: 'Female',
    rating: 4.6,
    reviewCount: 45
  },
  {
    id: '131',
    name: 'Dr. Putu Devi Oktapiani Putri',
    ...
    languages: ['Indonesian', 'English'],
    experienceYears: 5,
    procedures: ['General Medicine', 'Primary Care', 'Health Screening'],
    gender: 'Female',
    rating: 4.7,
    reviewCount: 89
  },
  {
    id: '132',
    name: 'Dr. Ngakan Putu Daksa Ganapati',
    specialty: 'Internal Medicine',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/d1128e64-f633-4036-854b-c467846989e6.jpg?1760617617',
    languages: ['Indonesian', 'English'],
    experienceYears: 12,
    procedures: ['Internal Medicine', 'Gastroenterology', 'Liver Disease Treatment'],
    gender: 'Male',
    rating: 4.8,
    reviewCount: 167
  },
  {
    ...
    languages: ['Indonesian', 'English'],
    experienceYears: 15,
    procedures: ['Orthopedic Surgery', 'Spine Surgery', 'Joint Reconstruction'],
    gender: 'Male',
    rating: 4.8,
    reviewCount: 198
  },
  {
    id: '134',
    name: 'Dr. Nurul Fitri Sabrina',
    specialty: 'General Practice',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/fa24cbf0-7f73-4b30-830b-3086fd38e961.JPG?1749524706',
    languages: ['Indonesian', 'English'],
    experienceYears: 8,
    procedures: ['General Medicine', 'Family Medicine', 'Preventive Care'],
    gender: 'Female',
    rating: 4.7,
    reviewCount: 112
  },
  {
    id: '135',
    name: 'Dr. I Gusti Lanang Ngurah Agung Artha Wiguna',
    specialty: 'Psychiatry',
    hospitalId: '141',
    hospitalName: 'Bali International Hospital',
    hospitalCountry: 'Indonesia',
    imageUrl: 'https://storage.googleapis.com/web-bih-bh-devel/doctors/75635f35-a368-4064-a5d9-9ae1e8130011.webp?1760601001',
    languages: ['Indonesian', 'English'],
    experienceYears: 18,
    procedures: ['Psychiatry', 'Mental Health Treatment', 'Anxiety & Depression Management'],
    gender: 'Male',
    rating: 4.8,
    reviewCount: 156
  }
