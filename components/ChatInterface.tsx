        ...
        for await (const chunk of stream) {
            ...
            const newMessages = messagesWithPlaceholder.map(m => 
                ...
                ? { 
                    ...
                    sources: accumulatedSources.length > 0 ? accumulatedSources : undefined, // Add sources
                                            ...
                                            <div className="mt-6 pt-4 border-t border-slate-100">
                                                ...
                                                <div className="grid gap-2">
                                                    {msg.sources.map((source, idx) => (
                                                        ...
                                                        >
                                                            <span className="font-medium text-slate-700 truncate flex-1 pr-2">{source.title}</span>
