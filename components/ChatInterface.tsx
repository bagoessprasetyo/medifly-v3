...
import { Send, Sparkles, User, Loader2, ArrowRight, LayoutGrid, MapPin, Star, PanelLeftClose, Paperclip, Bot, History, Plus, MessageSquare, Clock, Check, X, ChevronUp, ChevronDown, Search, Plane, FileText, Image as ImageIcon, MessageCircle, LogOut } from 'lucide-react';
                    ...
                    <div className="flex justify-center mb-3 animate-in fade-in slide-in-from-bottom-2">
                        {!user ? (
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-full shadow-sm hover:bg-white hover:shadow-md transition-all text-sm font-medium text-slate-700 group"
                            >
                                {isLoggingIn ? (
                            ...
                            <div className="flex items-center gap-2 p-1.5 pr-3 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-full shadow-sm">
