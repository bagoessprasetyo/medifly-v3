  ...
  const testimonialsCol1: Testimonial[] = [
    {
      ...
      name: '',
      role: '',
      thumbnail: '/images/testimonials/1.jpg',
    ...
    },
    {
      ...
      name: 'Sonia Ro',
      role: 'Member',
      thumbnail: '/images/testimonials/2.jpg',
      videoUrl: SAMPLE_VIDEO
    }
  ];
  ...
  const testimonialsCol2: Testimonial[] = [
    {
      ...
      name: '',
      role: '',
      thumbnail: '/images/testimonials/3.jpg',
      videoUrl: SAMPLE_VIDEO
    },
    {
      id: '4',
      name: 'Gordon Ro',
      role: 'Member',
      thumbnail: '/images/testimonials/4.jpg',
      videoUrl: SAMPLE_VIDEO
    },
    {
      id: '5',
      name: 'Michael Ro',
      role: 'Member',
      thumbnail: '/images/testimonials/5.png',
      videoUrl: SAMPLE_VIDEO
    }
  ];
  ...
  const testimonialsCol3: Testimonial[] = [
    {
      ...
      name: '',
      role: '',
      thumbnail: '/images/testimonials/6.png',
      videoUrl: SAMPLE_VIDEO
    },
    {
      id: '7',
      name: 'Alan Ro',
      role: 'Member',
      thumbnail: '/images/testimonials/7.png',
      videoUrl: SAMPLE_VIDEO
    }
  ];
      ...
      <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="h-[600px] lg:h-[720px] w-full relative overflow-hidden rounded-3xl">
          <div className="grid grid-cols-3 gap-3 lg:gap-4 h-full">
            ...
            {/* Column 2 (Offset) */}
            <div className="flex flex-col gap-3 lg:gap-4 -mt-16 animate-scroll-vertical" style={{ animationDuration: '40s' }}>
              {testimonialsCol2.map((t, i) => renderCard(t, i, true))}
              {testimonialsCol2.map((t, i) => renderCard({ ...t, id: t.id + '_dup' }, i, true))}
            </div>

            {/* Column 3 */}
            <div className="flex flex-col gap-3 lg:gap-4 animate-scroll-vertical" style={{ animationDuration: '40s' }}>
              {testimonialsCol3.map((t, i) => renderCard(t, i))}
              {testimonialsCol3.map((t, i) => renderCard({ ...t, id: t.id + '_dup' }, i))}
            </div>
