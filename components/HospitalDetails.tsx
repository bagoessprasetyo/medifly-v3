  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-6 pt-6 pb-4 flex-shrink-0">
         <h2 className="text-2xl font-bold text-slate-900 leading-tight">{hospital.name}</h2>
                ...
                <div className="flex-1 space-y-8">
                    ...
                    <div className="py-4 border-b border-slate-100 space-y-4">
                       <div className="flex gap-4">
                          ...
                          <div>
                             <h3 className="font-semibold text-slate-900">Internationally Accredited</h3>
                       ...
                       <div className="flex gap-4">
                          ...
                          <div>
                             <h3 className="font-semibold text-slate-900">Fast-Track Appointments</h3>
                    ...
                    {/* Specialties Tags */}
                    <div>
                        <h3 className="text-lg font-semibold text-slate-900 mb-3">Centers of Excellence</h3>
                    ...
                    <div className="py-4 border-t border-slate-100">
                       <h3 className="text-lg font-semibold text-slate-900 mb-3">Hospital Features</h3>
      ...
      <div className="p-6 pb-8 border-t border-slate-100 flex items-center justify-between bg-white z-10 flex-shrink-0">
         <div>
            <div className="flex items-baseline gap-1">
                <span className="text-xl font-bold text-slate-900">{hospital.priceRange}</span>
                <span className="text-slate-500 text-sm">est. range</span>
            </div>
            <div className="flex items-center gap-1 text-xs text-slate-500 mt-1">
               <span className="font-bold text-slate-900 underline">{hospital.reviewCount} reviews</span>
            </div>
         </div>
