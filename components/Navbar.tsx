        ...
        <div>
            ...
            <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-slate-100 h-20 w-full transition-all">
                ...
                <span className="text-lg font-semibold tracking-tight text-slate-900">Medifly</span> */}
                        <img src="/images/logo/logo.avif" alt="Logo" className="w-28" />
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        <button
                            onClick={onOpenCTA}
                            className="text-sm font-medium bg-slate-900 text-white px-5 py-2.5 rounded-lg hover:bg-slate-800 transition-colors shadow-sm hover:shadow-md"
                        >
                            {t('Get Started')}
                        </button>
                    </div>
                ...
                {isMobileMenuOpen && (
                    <div className="fixed inset-0 bg-white z-40 md:hidden flex flex-col pt-24 px-6 animate-in slide-in-from-top-10 duration-200">
                        ...
                        <div className="mt-8 space-y-4">
                            ...
                            <button
                                onClick={onOpenCTA}
                                className="w-full bg-slate-900 text-white text-base font-semibold py-4 rounded-xl hover:bg-black transition shadow-sm mt-4"
                            >
                                {t('Sign in')}
                            </button>
                        </div>
