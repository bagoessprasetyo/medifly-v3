            ...
            <div className={`max-w-[1600px] mx-auto w-full px-4 md:px-6 pt-6 md:pt-8 pb-20 flex flex-col lg:flex-row gap-8 lg:gap-12 flex-1 relative ${isChatOpen ? 'lg:flex-col' : ''}`}>
                ...
                <main className="flex-1 flex flex-col min-w-0">
                    ...
                    <div id="marketplace-search" className={`flex flex-col md:flex-row gap-3 mb-8 transition-all duration-300 relative z-20 ${isChatOpen ? 'hidden' : ''}`}>
                        ...
                        <div ref={specialtyRef} className="relative flex-grow w-full md:w-[45%]">
                            <button
                                ...
                                className={`min-h-[56px] flex hover:border-slate-300 transition-all duration-200 focus:outline-none text-left bg-white w-full h-auto border rounded-xl py-2.5 px-4 shadow-[0_1px_2px_rgba(0,0,0,0.02)] gap-x-3 items-center ${isSpecialtyOpen ? 'border-slate-400 ring-2 ring-slate-50' : 'border-slate-200'
                                    }`}
                            >
                    ...
                    <div className="flex-1 relative">
                                ...
                                {displayedHospitals.map(hospital => (
                                    ...
                                    >
                                        <HospitalCard
                                            ...
                                            compareBtnId={`compare-btn-${hospital.id}`}
                                        />
                                    </motion.div>
                                ))}
                        ...
                        {/* Load More Button */}
                        {visibleCount < filteredHospitals.length && viewMode === 'grid' && (
