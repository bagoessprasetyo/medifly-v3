...
import { DOCTORS, HOSPITALS, SPECIALIZATIONS } from '../constants';
...
export const DoctorDetailsPage: React.FC<DoctorDetailsPageProps> = ({ doctor, onBack, onNavigateToHospital, onViewDoctor, onViewSpecialization }) => {
    ...
    const [showSpecTooltip, setShowSpecTooltip] = useState(false);



    // Get specialization description

    const getSpecializationDescription = (specialty: string) => {
        ...
        return spec?.description || `Specialized medical care in ${specialty}`;
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span
                                    ...
                                    className="font-medium underline decoration-zinc-300 underline-offset-4 cursor-pointer hover:text-slate-600 hover:decoration-slate-400 transition-colors"

                                    onClick={() => onViewSpecialization?.(doctor.specialty)}
                                ...
                                <div className="relative inline-block ml-2">
                                    ...
                                    <Info
                                        ...
                                        className="w-3.5 h-3.5 text-zinc-400 cursor-pointer hover:text-zinc-600 transition-colors inline"

                                        onMouseEnter={() => setShowSpecTooltip(true)}

                                        onMouseLeave={() => setShowSpecTooltip(false)}

                                    />

                                    {showSpecTooltip && (

                                        <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 w-64 p-3 bg-slate-900 text-white text-xs rounded-lg shadow-lg z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">

                                            <div className="font-medium mb-1">{doctor.specialty}</div>

                                            <div className="text-slate-300 leading-relaxed">{getSpecializationDescription(doctor.specialty)}</div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        >
                            ...
                            <div className=" border-zinc-100 pt-2">
